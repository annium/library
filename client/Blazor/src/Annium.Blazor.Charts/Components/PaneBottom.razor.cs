...
/// <summary>
/// Bottom pane component that provides a horizontal side area at the bottom of a chart pane
/// </summary>
public partial class PaneBottom : ILogSubject, IAsyncDisposable
{
    ...
    /// <summary>
    /// The managed horizontal side context for this bottom pane
    /// </summary>
    [Inject]
    ...
    /// <summary>
    /// CSS styles for the PaneBottom component
    /// </summary>
