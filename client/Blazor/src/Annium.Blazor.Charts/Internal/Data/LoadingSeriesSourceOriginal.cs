...
internal class LoadingSeriesSourceOriginal<TData> : ISeriesSource<TData>, ILogSubject<LoadingSeriesSourceOriginal<TData>>
    where TData : ITimeSeries
{
    public Duration Resolution { get; private set; }
    public bool IsLoading => Volatile.Read(ref _isLoading) == 1;
    public ILogger<LoadingSeriesSourceOriginal<TData>> Logger { get; }
...
internal interface ILoadingSeriesSourceOriginal
{
}