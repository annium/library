...
public static class InstanceRegistrationBuilderExtensions
{
    ...
    public static IBuilderTarget AsKeyed<T, TKey>(this IBuilderTarget builder, TKey key)
        where TKey : notnull => builder.AsKeyed(typeof(T), key);

    public static IBuilderTarget AsFactory<T>(this IBuilderTarget builder) => builder.AsFactory(typeof(T));

    public static IBuilderTarget AsKeyedFactory<T, TKey>(this IBuilderTarget builder, TKey key)
        where TKey : notnull => builder.AsKeyedFactory(typeof(T), key);
}
