...
/// <summary>
/// A YAML serializer implementation that exchanges <see cref="ReadOnlyMemory{T}"/> of
/// <see cref="byte"/> as the UTF-8 encoding of the underlying YAML text.
/// </summary>
internal class ReadOnlyMemoryByteSerializer : ISerializer<ReadOnlyMemory<byte>>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ReadOnlyMemoryByteSerializer"/> class.
    /// </summary>
    /// <param name="serializer">The YAML serializer to use.</param>
    /// <param name="deserializer">The YAML deserializer to use.</param>
    public ReadOnlyMemoryByteSerializer(ISerializer serializer, IDeserializer deserializer)
    {
    ...
    /// <summary>
    /// Deserializes a UTF-8 buffer of YAML text into the specified type.
    /// </summary>
    /// <typeparam name="T">The type to deserialize to.</typeparam>
    /// <param name="value">The buffer containing UTF-8 YAML text.</param>
    /// <returns>The deserialized object.</returns>
    public T Deserialize<T>(ReadOnlyMemory<byte> value)
    {
        var text = Encoding.UTF8.GetString(value.Span);
        try
        {
    ...
    /// <summary>
    /// Deserializes a UTF-8 buffer of YAML text into the specified runtime type.
    /// </summary>
    ...
    /// <summary>
    /// Serializes an object to a buffer containing UTF-8 YAML text.
    /// </summary>
    ...
    /// <summary>
    /// Serializes an object of the specified runtime type to UTF-8 YAML bytes.
    /// </summary>
