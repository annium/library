...
public enum ConnectorDelivery
{
    ...
    /// delivery makes "it has been delivered" the same moment as "the write returned".
    ///
    /// A subscriber that blocks blocks the writer. That is the point, and it is only safe because the
