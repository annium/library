...
using Annium.Finance.Providers.Crypto.Binance.Base.Internal.Contracts.User.Domain;

namespace Annium.Finance.Providers.Crypto.Binance.Base.Internal.Contracts.User.Converters;

internal class ListenKeyResponseConverter : JsonConverter<ListenKey>
{
