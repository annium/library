...
public class OrderExtensionsTests
{
    ...
    // [Fact]
    // public void LeveragedTotalValue()
    // {
    //     // arrange
    //     var position = Helper.CreatePosition(2);
    //
    //     // assert
    //     position.AddLimitBuyOrder(5, 15).Fill().LeveragedTotalValue().Is(37.5m);
    // }

    // [Fact]
    // public void FullExpenseSum()
    // {
    //     // arrange
    //     var position = Helper.CreatePosition(2);
    //
    //     // assert
    //     position.AddLimitBuyOrder(5, 15).Fill().FullExpenseSum().Is(75m.PlusFee());
    // }

    // [Fact]
    // public void LeveragedExpenseSum()
    // {
    //     // arrange
    //     var position = Helper.CreatePosition(2);
    //
    //     // assert
    //     position.AddLimitBuyOrder(5, 15).Fill().LeveragedExpenseSum().Is(37.5m.PlusFee(position.Leverage));
    // }

    // [Fact]
    // public void FullRevenueSum()
    // {
    //     // arrange
    //     var position = Helper.CreatePosition(2);
    //
    //     // assert
    //     position.AddLimitBuyOrder(5, 15).Fill().FullRevenueSum().Is(75m.MinusFee());
    // }

    // [Fact]
    // public void LeveragedRevenueSum()
    // {
    //     // arrange
    //     var position = Helper.CreatePosition(2);
    //
    //     // assert
    //     position.AddLimitBuyOrder(5, 15).Fill().LeveragedRevenueSum().Is(37.5m.MinusFee(position.Leverage));
    // }

    // [Fact]
    // public void FullExecutedSum()
    // {
    //     // arrange
    //     var position = Helper.CreatePosition(2);
    //
    //     // assert
    //     position.AddLimitBuyOrder(5, 15).Fill().FullExecutedSum().Is(75m);
    // }

    // [Fact]
    // public void LeveragedExecutedSum()
    // {
    //     // arrange
    //     var position = Helper.CreatePosition(2);
    //
    //     // assert
    //     position.AddLimitBuyOrder(5, 15).Fill().LeveragedExecutedSum().Is(37.5m);
    // }
