...
public class HttpRequestUserResultExtensionsTests : ProvidersTestBase
{
    ...
    /// <returns>A task representing the asynchronous operation.</returns>
    [Theory]
    [InlineData(HttpStatusCode.BadRequest, UserOperationStatus.BadRequest, "not json")]
    [InlineData(HttpStatusCode.BadRequest, UserOperationStatus.BadRequest, "{}")]
    [InlineData((HttpStatusCode)418, UserOperationStatus.TooManyRequests, "<html>banned</html>")]
    [InlineData(HttpStatusCode.TooManyRequests, UserOperationStatus.TooManyRequests, "not json")]
    ...
    /// <see cref="UserOperationStatus.BadRequest"/>, any other recognized code to
