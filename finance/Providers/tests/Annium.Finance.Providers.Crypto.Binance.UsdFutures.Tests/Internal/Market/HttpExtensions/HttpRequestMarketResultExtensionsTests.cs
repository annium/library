...
namespace Annium.Finance.Providers.Crypto.Binance.UsdFutures.Tests.Internal.Market.HttpExtensions;
...
/// <see cref="MarketOperationStatus"/>, against a fully wired USD-M futures provider registration.
/// </summary>
public class HttpRequestMarketResultExtensionsTests : ProvidersTestBase
{
    ...
    /// <summary>
    /// Registers the Binance USD-M futures provider so the extension is exercised through its actual request pipeline.
    /// </summary>
