...
namespace Annium.Finance.Providers.Crypto.Binance.UsdFutures.Tests.Internal.Shared.TimeSync;
...
public class ServerTimeProviderTests : ProvidersTestBase
{
    ...
    /// <summary>
    /// Registers the Binance USD-M futures provider so the time source under test is resolved from its actual registration.
    /// </summary>
