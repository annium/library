...
namespace Annium.Finance.Providers.Crypto.Binance.UsdFutures.Tests.Internal.User.HttpExtensions;
...
/// <see cref="UserOperationStatus"/>, against a fully wired USD-M futures provider registration.
/// </summary>
