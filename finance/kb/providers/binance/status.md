...
- last reconciled: 2026-09-20 — step 5 complete. The conditional-order migration that blocked 5f's
  fourth stage is implemented and live, the write block has run end to end three times clean, and a
  defect found by a run afterwards is fixed. Before it: 2026-09-18, step 1 re-run against the tree,
  opening the contract pass that unblocked the migration; steps 5a through 5e merged; step 4's residue
  worked through, four of its six items closed
...
## Spot step 5 — where it stops, 2026-09-21
