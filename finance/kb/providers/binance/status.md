...
- last reconciled: 2026-09-18 — steps 5a through 5d merged (six defects found and fixed); 5e under way on
  `provider/binance-step-5e`, where the queued list below was verified item by item against the code
