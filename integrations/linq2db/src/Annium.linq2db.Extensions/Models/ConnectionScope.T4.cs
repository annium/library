...
/// <summary>
/// Represents a scoped database connection that manages the lifetime of four DataConnection instances.
    ...
    where T4 : DataConnection
{
    ...
    /// When false, guarantees that Cn1, Cn2, Cn3, and Cn4 are not null.
    /// </summary>
    ...
    /// After this method returns normally, Cn1, Cn2, Cn3, and Cn4 are guaranteed to be non-null.
    /// </summary>
