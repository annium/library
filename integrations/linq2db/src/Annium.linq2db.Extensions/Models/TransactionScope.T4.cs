...
/// <summary>
/// Represents a scoped database transaction that manages the lifetime of four DataConnections and their transactions.
...
/// <typeparam name="T4">The type of the fourth DataConnection to manage</typeparam>
    ...
    where T4 : DataConnection
{
    ...
    /// When false, guarantees that Cn1, Txn1, Cn2, Txn2, Cn3, Txn3, Cn4, and Txn4 are not null.
    /// </summary>
    [MemberNotNullWhen(
        false,
        nameof(Cn1),
    ...
    /// <summary>
    /// Gets the fourth managed DataConnection instance. Will be null if the scope is disposed.
    /// </summary>
    public T4? Cn4 { get; init; } = null;

    /// <summary>
    /// Gets the fourth managed DataConnectionTransaction instance. Will be null if the scope is disposed.
    /// </summary>
    public Dct? Txn4 { get; init; } = null;

    /// <summary>
    /// The underlying service scope that manages the lifetime of all four DataConnections and their dependencies
    /// </summary>
    ...
    /// <param name="cn4">The fourth DataConnection instance to manage</param>
    /// <param name="txn4">The fourth DataConnectionTransaction instance to manage</param>
    ...
    /// After this method returns normally, Cn1, Txn1, Cn2, Txn2, Cn3, Txn3, Cn4, and Txn4 are guaranteed to be non-null.
    /// </summary>
    ...
    /// <param name="cn4">The fourth DataConnection instance</param>
    /// <param name="txn4">The fourth DataConnectionTransaction instance</param>
    /// <exception cref="ObjectDisposedException">Thrown when the transaction scope is disposed</exception>
