...
{
    internal class CompositionPipeHandler<TRequest> : CompositionPipeHandlerBase<TRequest, IStatusResult<OperationStatus>>, IPipeRequestHandler<TRequest, TRequest, IStatusResult<OperationStatus>, IStatusResult<OperationStatus>> where TRequest : class
    {
