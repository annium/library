...
namespace Annium.Core.Application.Tests.Types.Extensions.ResolveGenericArgumentsByImplentation
{
    ...
    public struct StructParamatered { public int X { get; } public StructParamatered(int x) { X = x; } }
