...
/// <summary>
/// WebSocket-based implementation of a server connection for mesh transport.
/// </summary>
internal sealed class ServerConnection : IServerConnection, ILogSubject
{
    ...
    /// </summary>
    /// <param name="socket">The server WebSocket to use for communication.</param>
    /// <param name="logger">The logger instance.</param>
    public ServerConnection(IServerWebSocket socket, ILogger logger)
    {
        Logger = logger;
        _socket = socket;
    ...
    /// <summary>
    /// Sends data asynchronously through the WebSocket server connection
    /// </summary>
