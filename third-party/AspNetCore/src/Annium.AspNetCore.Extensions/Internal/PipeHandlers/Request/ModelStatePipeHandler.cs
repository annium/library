...
{
    internal class ModelStatePipeHandler<TRequest> : ModelStatePipeHandlerBase<TRequest, IStatusResult<OperationStatus>>, IPipeRequestHandler<ValueTuple<ModelStateDictionary, TRequest>, TRequest, IStatusResult<OperationStatus>, IStatusResult<OperationStatus>>
    {
