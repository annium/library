...
{
    internal class ModelStatePipeHandler<TRequest, TResponse> :
        ModelStatePipeHandlerBase<TRequest, IStatusResult<OperationStatus, TResponse>>,
        IPipeRequestHandler<ValueTuple<ModelStateDictionary, TRequest>, TRequest, IStatusResult<OperationStatus, TResponse>,
