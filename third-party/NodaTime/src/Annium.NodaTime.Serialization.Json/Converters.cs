...
public static class Converters
{
    ...
    /// </summary>
    public static JsonConverter InstantConverter { get; } = new NodaPatternConverter<Instant>(InstantPattern.ExtendedIso);

    /// <summary>
    /// Converter for local dates, using the ISO-8601 date pattern.
    /// </summary>
    public static JsonConverter LocalDateConverter { get; } = new NodaPatternConverter<LocalDate>(
    ...
    /// </summary>
    public static JsonConverter LocalDateTimeConverter { get; } = new NodaPatternConverter<LocalDateTime>(
    ...
    /// </summary>
    public static JsonConverter LocalTimeConverter { get; } = new NodaPatternConverter<LocalTime>(LocalTimePattern.ExtendedIso);
    ...
    /// </summary>
    public static JsonConverter OffsetConverter { get; } = new NodaPatternConverter<Offset>(OffsetPattern.GeneralInvariant);
    ...
    /// </summary>
    public static JsonConverter RoundtripPeriodConverter { get; } = new NodaPatternConverter<Period>(PeriodPattern.Roundtrip);
