...
namespace Annium.NodaTime.Serialization.Json.Tests
{
    ...
    {
        private readonly JsonConverter[] converters = new [] { Converters.IsoIntervalConverter };
        ...
        public void RoundTrip()
        {
            ...
            AssertConversions(interval, "\"2012-01-02T03:04:05.67Z/2013-06-07T08:09:10.123456789Z\"", converters);
        }
        ...
        public void RoundTrip_Infinite()
        {
            ...
            AssertConversions(new Interval(null, instant), "\"/2013-06-07T08:09:10.123456789Z\"", converters);
            AssertConversions(new Interval(instant, null), "\"2013-06-07T08:09:10.123456789Z/\"", converters);
        ...
        public void DeserializeComma()
        {
            ...
            var interval = JsonSerializer.Deserialize<Interval>(json, With(converters));
